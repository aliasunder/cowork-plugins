...
The trip-orchestrator plugin bundles a `dashboard.html` — a visual kanban board for TASKS.md with a memory browser. It's a standalone single-file app with no external dependencies.
