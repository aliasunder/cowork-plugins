...
| [obsidian-vault](obsidian-vault/) | Always-on Obsidian conventions for Claude Cowork vaults. Keeps note editing consistent across sessions — wikilinks, frontmatter, callouts, embeds, and plugin-aware syntax for Dataview, Tasks, Templater, Bases, and Canvas. |
